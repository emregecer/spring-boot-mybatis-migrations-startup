package com.emregecer.mybatis.migrations.config;
...
public class MyBatisMigrationsConfig {
    ...
    private static final String scriptsDir = "migrations/scripts";
    ...
    private static class MyBatisMigrationsPopulator implements DatabasePopulator {
        ...
        public MyBatisMigrationsPopulator(DataSource dataSource,
                                          String scriptsDir,
                                          Properties properties,
                                          DatabaseOperationOption options,
